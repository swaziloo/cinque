...
//
//  swaziloo hacked multi-display footprint
...
//    `
    ...
    (fp_line (start 6.35 15.48) (end 6.35 17.97) (layer "F.CrtYd") (stroke (width 0.15) (type solid)))
    (fp_line (start 6.35 17.97) (end 5.08 17.97) (layer "F.CrtYd") (stroke (width 0.15) (type solid)))
    (fp_line (start 5.08 17.97) (end 5.08 19.52) (layer "F.CrtYd") (stroke (width 0.15) (type solid)))
    (fp_line (start 5.08 19.52) (end -5.08 19.52) (layer "F.CrtYd") (stroke (width 0.15) (type solid)))
    (fp_line (start -5.08 19.52) (end -5.08 17.97) (layer "F.CrtYd") (stroke (width 0.15) (type solid)))
    (fp_line (start -5.08 17.97) (end -6.35 17.97) (layer "F.CrtYd") (stroke (width 0.15) (type solid)))
    (fp_line (start -6.35 17.97) (end -6.35 15.43) (layer "F.CrtYd") (stroke (width 0.15) (type solid)))
    (fp_line (start -6.35 15.43) (end 6.35 15.43) (layer "F.CrtYd") (stroke (width 0.15) (type solid)))
    `
...
//    `
    ...
    const bottom = `
    (pad "1" thru_hole oval (at -5.08 16.7 ${270 + p.r}) (size 1.7 1.7) (drill 1) (layers "*.Cu" "*.Mask") ${socket_nets[4].str})
    (pad "2" thru_hole oval (at -2.54 16.7 ${270 + p.r}) (size 1.7 1.7) (drill 1) (layers "*.Cu" "*.Mask") ${socket_nets[3].str})
    (pad "3" thru_hole oval (at 0 16.7 ${270 + p.r}) (size 1.7 1.7) (drill 1) (layers "*.Cu" "*.Mask") ${socket_nets[2].str})
    (pad "4" thru_hole oval (at 2.54 16.7 ${270 + p.r}) (size 1.7 1.7) (drill 1) (layers "*.Cu" "*.Mask") ${socket_nets[1].str})
    (pad "5" thru_hole circle (at 5.08 16.7 ${270 + p.r}) (size 1.7 1.7) (drill 1) (layers "*.Cu" "*.Mask") ${socket_nets[0].str})

    (pad "2" thru_hole oval (at -3.81 18.25 ${270 + p.r}) (size 1.7 1.7) (drill 1) (layers "*.Cu" "*.Mask") ${socket_nets[4].str})
    (pad "3" thru_hole oval (at -1.27 18.25 ${270 + p.r}) (size 1.7 1.7) (drill 1) (layers "*.Cu" "*.Mask") ${socket_nets[3].str})
    (pad "4" thru_hole oval (at 1.27 18.25 ${270 + p.r}) (size 1.7 1.7) (drill 1) (layers "*.Cu" "*.Mask") ${socket_nets[2].str})
    (pad "5" thru_hole oval (at 3.81 18.25 ${270 + p.r}) (size 1.7 1.7) (drill 1) (layers "*.Cu" "*.Mask") ${socket_nets[1].str})
