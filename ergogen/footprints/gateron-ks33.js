...
//      properly soldered.
//    inner_pad_width: default 2.6
//      Reduce the inner pad size to match the outer pad if desired.
...
//      model relative the footprint.
//
//    Hacked by swaziloo to convert to KS-33 5.25mm center & NPTH 
...
module.exports = {
  ...
  (footprint "ceoloide:switch_gateron_ks27_ks33"
    ...
    ${''/* middle shaft hole */}
    (pad "" np_thru_hole circle (at 0 0 ${p.r}) (size 5.25 5.25) (drill 5.25) (layers "*.Cu" "*.Mask"))
    `
    ...
    (pad "1" smd roundrect (at ${-6.25 + (2.6 - p.inner_pad_width) /2} 5.75 ${p.r}) (size ${p.inner_pad_width} 2.5) (layers "F.Cu") (roundrect_rratio 0.1) ${p.from.str})
    (pad "" smd roundrect (at ${-6.25 + (2.6 - p.inner_pad_width) /2} 5.75 ${p.r}) (size ${p.inner_pad_width} 2.5) (layers "F.Paste" "F.Mask") (roundrect_rratio 0.1))
    `

    const hotswap_back_full = `
    (pad "2" smd roundrect (at ${6.25 - (2.6 - p.inner_pad_width) /2} 5.75 ${p.r}) (size ${p.inner_pad_width} 2.5) (layers "B.Cu") (roundrect_rratio 0.1) ${p.to.str})
    (pad "" smd roundrect (at ${6.25 - (2.6 - p.inner_pad_width) /2} 5.75 ${p.r}) (size ${p.inner_pad_width} 2.5) (layers "B.Paste" "B.Mask") (roundrect_rratio 0.1))
    `

    const hotswap_front = `
    (pad ${p.reversible ? '""' : '"1"'} np_thru_hole circle (at -2.6 5.75 ${p.r}) (size 3 3) (drill 3) (layers "*.Cu" "*.Mask"))
    (pad "2" np_thru_hole circle (at 4.4 4.7 ${p.r}) (size 3 3) (drill 3) (layers "*.Cu" "*.Mask"))

    (pad "2" smd roundrect (at ${8.05 - (2.6 - p.outer_pad_width_front) / 2} 4.7 ${p.r}) (size ${p.outer_pad_width_front} 2.5) (layers "F.Cu") (roundrect_rratio 0.1) ${p.to.str})
    ...
    ${!p.reversible ? hotswap_front_full
        : `(pad "1" smd roundrect (at ${-6.25 + (2.6 - p.inner_pad_width) /2} 5.75 ${p.r}) (size ${p.inner_pad_width} 2.5) (layers "F.Cu" "F.Paste" "F.Mask") (roundrect_rratio 0.1) ${p.from.str})`}
    `

    const hotswap_back = `
    (pad "1" np_thru_hole circle (at -4.4 4.7 ${p.r}) (size 3 3) (drill 3) (layers "*.Cu" "*.Mask"))
    (pad ${p.reversible ? '""' : '"2"'} np_thru_hole circle(at 2.6 5.75 ${p.r}) (size 3 3) (drill 3) (layers "*.Cu" "*.Mask"))

    
    (pad "1" smd roundrect (at ${-8.05 + (2.6 - p.outer_pad_width_back) / 2} 4.7 ${p.r}) (size ${p.outer_pad_width_back} 2.5) (layers "B.Cu") (roundrect_rratio 0.1) ${p.from.str})
    ...
    ${!p.reversible ? hotswap_back_full
        : `(pad "2" smd roundrect (at ${6.25 - (2.6 - p.inner_pad_width) /2} 5.75 ${p.r}) (size ${p.inner_pad_width} 2.5) (layers "B.Cu" "B.Paste" "B.Mask") (roundrect_rratio 0.1) ${p.to.str})`}
    `
